<template>
  <div
    class="relative w-[200px] h-[250px] bg-[#f7f7f7] rounded-lg shadow-md flex flex-col border border-[#525392] cursor-pointer hover:scale-[1.02] transition-transform"
    @click="$emit('select', item)"
  >
    <div class="absolute top-2 left-35 text-[#525392]">
      <button
    ...
    <div class="px-5 pt-9">
      ...
      <p class="text-black text-xs truncate">Due in: {{ item.due_in }} days</p>
    </div>
